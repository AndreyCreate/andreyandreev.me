...
.ig{display:inline-flex;align-items:center;gap:6px;font-family:'JetBrains Mono',monospace;font-size:13px;color:var(--bl);text-decoration:none;border:1px solid currentColor;border-radius:99px;padding:7px 14px;margin:12px 8px 0 0;white-space:nowrap}.ig:hover{background:var(--bl);color:#fff}.dark .ig{color:#8cc4ff}.dark .ig:hover{background:#8cc4ff;color:#111}.vs{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.vs video{width:100%;aspect-ratio:4/5;object-fit:cover;border-radius:12px;background:#ddd;display:block}@media(max-width:980px){.vs{grid-template-columns:1fr 1fr}}.ig+blockquote,.ig+.rows,.ig+.nums{margin-top:24px}.tbl div span a{color:inherit;text-decoration:underline;text-decoration-color:var(--bl);text-underline-offset:4px}.nums span a,figcaption a{color:var(--bl)}.dark .nums span a{color:#8cc4ff}
...
SALES = ["Введение: что будем делать и к чему должны прийти","Настраиваем агента-маркетолога","Разбираем свои текущие продукты","Продуктовая матрица: какой продукт следующий и почему","Мини-продукт и лид-магнит: когда нужны и как собрать","Создание лендингов и офферов","Собираем воронки голосом","Прогрев и Лестница Бена Ханта"]
...
grosz = carousel("c-grosz", [f"../img/grosz_{i}.jpg" for i in range(9)], "Стивен Гросс, «The Examined Life» · обложка + 8 цитат · 29 августа")
...
<div class="week" style="margin-top:80px"><span>20 августа</span><span>Третья часть трилогии: «Сериалы». Карусель, в которой все десять слайдов — видео</span></div>
<div class="vs" style="margin-top:26px"><video autoplay muted loop playsinline preload="metadata" poster="../v/ser_s0.jpg" src="../v/ser_s0.mp4"></video><video autoplay muted loop playsinline preload="metadata" poster="../v/ser_s1.jpg" src="../v/ser_s1.mp4"></video><video autoplay muted loop playsinline preload="metadata" poster="../v/ser_s2.jpg" src="../v/ser_s2.mp4"></video><video autoplay muted loop playsinline preload="metadata" poster="../v/ser_s5.jpg" src="../v/ser_s5.mp4"></video></div>
<div class="grid two" style="margin-top:30px"><div><div class="price">10 видео-слайдов</div><div class="sub">кадры из сериалов под каждым приёмом, <b>без видеоредактора</b></div>{ig("DcRGQTojHLX", "карусель в Instagram")}{ig("DcRaBI9xUuJ", "рилс из неё", "reel")}</div>
<div>{rows([("01", "после «Книг» и «Фильмов» — восемь приёмов сценаристов, которые переносятся в тексты", ""), ("02", "агент сам нашёл трейлеры, вырезал фрагменты по 8 секунд и перевёл в чёрно-белое", ""), ("03", "вставил видео в слайды моей дизайн-системы: обложка, восемь приёмов, финал", ""), ("04", "в тот же вечер из этой карусели одним сообщением собран рилс: 33 422 просмотра", "ok")])}
<div class="note">Честно про цифры: сама карусель собрала 13 112 просмотров и 212 сохранений, это ниже моей медианы. Выстрелил рилс из неё. Кейс не про охват, а про то, что видео-карусель и рилс из одного материала — это один вечер и два сообщения агенту.</div></div></div>

<div class="week" style="margin-top:80px"><span>29 августа</span><span>Обычный выпуск цитатной серии: психоаналитик, которого в России почти не знают</span></div>
<div class="grid wide" style="margin-top:26px">{grosz}<div><div class="price">42 863 просмотра</div><div class="sub">охват 23 078 · 542 сохранения · <b>198 репостов</b></div>{ig("DcnbKZXDFau", "карусель Гросса в Instagram")}
{rows([("01", "«покажи цитаты» — агент приносит 22 цитаты и биографию: книга, интервью и рецензии Guardian", ""), ("02", "я выбираю восемь, одну перефразирую", ""), ("03", "агент верстает обложку и восемь слайдов, пишет текст поста", ""), ("04", "голосовым прошу цитату на обложку позвучнее — через несколько минут новая обложка", "ok")])}
<div class="note">Это не лучший выпуск, а средний: его охват почти совпадает с медианой серии, 22 998. В этом и смысл конвейера — не один вирусный пост, а двадцать каруселей подряд, и каждая стоит мне двух-трёх сообщений.</div></div></div>
...
{lessons("Блок 02", "Продажи", "8 уроков · агент-маркетолог, продукты, воронка", SALES)}</div>
