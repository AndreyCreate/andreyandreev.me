/* @ds-bundle: {"format":4,"namespace":"HeySashDesignSystem_7f4ac5","components":[{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Card","sourcePath":"components/core/Card.jsx"},{"name":"Chip","sourcePath":"components/core/Chip.jsx"},{"name":"IconButton","sourcePath":"components/core/IconButton.jsx"},{"name":"StatusChip","sourcePath":"components/core/StatusChip.jsx"}],"sourceHashes":{"components/core/Button.jsx":"91c3e480dfce","components/core/Card.jsx":"09e95750ec60","components/core/Chip.jsx":"895a480317f7","components/core/IconButton.jsx":"cac714614dca","components/core/StatusChip.jsx":"46422d0bbc7e","decks/deck-stage.js":"aca75f4098bc","ui_kits/composer-app/ComposerScreen.jsx":"e7a83e13dbf6","ui_kits/composer-app/FontPickerScreen.jsx":"5d6ad89d6250","ui_kits/composer-app/Icons.jsx":"b6ce0e8d3bde","ui_kits/composer-app/ManagerScreen.jsx":"135a798826eb","ui_kits/composer-app/PhoneFrame.jsx":"53b56218decb"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.HeySashDesignSystem_7f4ac5 = window.HeySashDesignSystem_7f4ac5 || {});
...
function Card({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      overflow: 'hidden',
      background: image ? `center/cover no-repeat url(${image})` : dark ? 'var(--ink-900)' : 'var(--white)',
      color: image || dark ? 'var(--white)' : 'var(--ink-900)',
      boxShadow: image ? 'none' : 'var(--shadow-sm)',
      padding: 'var(--space-4)',
      minHeight: 140,
      display: 'flex',
    ...
    style: {
      position: 'absolute',
      inset: 0,
      background: 'linear-gradient(to top, rgba(10,9,8,0.75), rgba(10,9,8,0) 55%)'
    }
...
function Chip({
  ...
  return /*#__PURE__*/React.createElement("span", {
    ...
    style: {
      ...
      padding: '8px 14px',
      borderRadius: 'var(--radius-pill)',
      font: mono ? 'var(--text-mono-sm)' : 'var(--text-body-sm)',
      letterSpacing: mono ? 'var(--letter-spacing-mono)' : 'normal',
      cursor: onClick ? 'pointer' : 'default',
      boxShadow: selected ? 'var(--shadow-orange-glow)' : 'none',
      whiteSpace: 'nowrap'
    }
  }, children);
}
...
function IconButton({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      border: 'none',
      background: bg,
      color: tone === 'neutral' ? 'var(--ink-900)' : 'var(--white)',
      display: 'inline-flex',
      alignItems: 'center',
      justifyContent: 'center',
      cursor: 'pointer',
...
function StatusChip({
  ...
  return /*#__PURE__*/React.createElement("span", {
    style: {
      ...
      color: tone === 'inverse' ? 'var(--white)' : 'var(--ink-500)'
    }
  }, icon, children);
}
...
// ui_kits/composer-app/ComposerScreen.jsx
try { (() => {
const {
  Mic
} = window;
function ComposerScreen() {
  ...
  const [text, setText] = React.useState('Это то, что джуны не нужны, их никто расскажет про то, как сложно диз');
  return /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\u041D\u043E\u0432\u044B\u0439 \u043F\u043E\u0441\u0442"), /*#__PURE__*/React.createElement("textarea", {
    value: text,
  ...
  }, "\u2713 \u041F\u0438\u0448\u0435\u0442 \u0418\u0418"), /*#__PURE__*/React.createElement("span", {
    style: {
      background: 'var(--ink-100)',
      color: 'var(--ink-700)',
      font: 'var(--text-mono-sm)',
    ...
    style: {
      ...
      color: 'var(--white)',
      cursor: 'pointer',
      boxShadow: recording ? 'var(--shadow-orange-glow)' : 'var(--shadow-sm)',
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/composer-app/ComposerScreen.jsx", error: String((e && e.message) || e) }); }

// ui_kits/composer-app/FontPickerScreen.jsx
try { (() => {
const pairs = {
  Serif: {
...
function FontPickerScreen() {
  const [choice, setChoice] = React.useState('Serif');
  return /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '10px 18px 24px',
      display: 'flex',
  ...
  }, "Handpicked", /*#__PURE__*/React.createElement("br", null), "Font pairs"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 18
    }
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, "for attention")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      marginBottom: 20
    }
  }, Object.keys(pairs).map(k => /*#__PURE__*/React.createElement("button", {
    key: k,
    onClick: () => setChoice(k),
    style: {
      border: 'none',
      ...
      padding: '10px 18px',
      borderRadius: 'var(--radius-pill)',
      background: choice === k ? 'var(--orange-500)' : 'var(--ink-900)',
      color: 'var(--white)',
    ...
    style: {
      fontFamily: pairs[choice].display,
      fontSize: 34,
      lineHeight: 1.3,
      color: 'var(--ink-900)'
    }
  }, pairs[choice].sample, " ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--orange-500)'
    }
  }, "this"), /*#__PURE__*/React.createElement("br", null), "little beautiful shadows")));
}
window.FontPickerScreen = FontPickerScreen;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/composer-app/FontPickerScreen.jsx", error: String((e && e.message) || e) }); }

// ui_kits/composer-app/Icons.jsx
try { (() => {
const wrap = (paths, props) => /*#__PURE__*/React.createElement("svg", {
  width: props.size || 18,
...
const Mic = (p = {}) => wrap(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
...
const Pencil = (p = {}) => wrap(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
  d: "M12 20h9"
}), /*#__PURE__*/React.createElement("path", {
  d: "M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"
})), p);
const Copy = (p = {}) => wrap(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("rect", {
  x: "9",
  y: "9",
  width: "13",
  height: "13",
...
const Trash = (p = {}) => wrap(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
  d: "M3 6h18"
}), /*#__PURE__*/React.createElement("path", {
...
const Heart = (p = {}) => /*#__PURE__*/React.createElement("svg", {
  width: p.size || 14,
  height: p.size || 14,
  viewBox: "0 0 24 24",
  fill: p.color || 'currentColor'
}, /*#__PURE__*/React.createElement("path", {
  d: "M12 21s-7.5-4.6-10-9C0.3 8.5 2 4 6 4c2.2 0 3.8 1.3 6 3.8C14.2 5.3 15.8 4 18 4c4 0 5.7 4.5 4 8-2.5 4.4-10 9-10 9Z"
}));
const Clock = (p = {}) => wrap(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("circle", {
  cx: "12",
  cy: "12",
  r: "9"
}), /*#__PURE__*/React.createElement("path", {
...
const Signal = (p = {}) => wrap(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
  d: "M2 20h.01M7 20v-4M12 20v-8M17 20v-12M22 20V4"
})), p);
const Battery = (p = {}) => wrap(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("rect", {
  x: "1",
  y: "7",
  width: "18",
  height: "10",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/composer-app/Icons.jsx", error: String((e && e.message) || e) }); }

// ui_kits/composer-app/ManagerScreen.jsx
try { (() => {
const {
  Pencil,
  Copy,
...
const carousels = [{
  title: '5 рецептов пиццы, которые изменят ваш взгляд на вкус',
  likes: 10,
  date: '28.02',
  img: '../../assets/photography/wine-cat.png'
}, {
  title: 'Личный бренд — простые шаги от дизайна до продвижения',
  likes: 12,
  date: '27.02',
  img: '../../assets/photography/night-blur.png'
}, {
  title: 'Sky Mavis is building the future of gaming.',
  likes: 7,
  date: '',
  img: '../../assets/photography/road-mountains.png',
  dark: true
}, {
  title: 'Продолжаем пилить приложение. День 2',
  likes: 4,
  date: '',
  img: '../../assets/photography/sailboat-sea.png',
  dark: true
}];
function ManagerScreen() {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Manage"), /*#__PURE__*/React.createElement("h1", {
    style: {
      font: 'var(--text-display-sm)',
      fontFamily: 'var(--font-display)',
      letterSpacing: 'var(--letter-spacing-display)',
  ...
  }, "your posts easily"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
  ...
  }, "\u041C\u043E\u0438 \u043A\u0430\u0440\u0443\u0441\u0435\u043B\u0438"), /*#__PURE__*/React.createElement("span", {
    style: {
      font: 'var(--text-mono-xs)',
      color: 'var(--orange-600)'
    }
  }, "89 \u043F\u043E\u0441\u0442\u043E\u0432")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
      gap: 10
    }
  }, carousels.map((c, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    ...
    style: {
      ...
      cursor: 'pointer',
      height: 150,
      background: c.dark ? 'var(--ink-900)' : `center/cover url(${c.img})`
    }
  }, !c.dark && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      inset: 0,
      background: 'linear-gradient(to top, rgba(10,9,8,0.75), rgba(10,9,8,0) 60%)'
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
    ...
    size: 12,
    color: "white"
  }), " ", c.likes), c.date && /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 4
    ...
    size: 12,
    color: "white"
  }), " ", c.date))), openIdx === i && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      top: 8,
      right: 8,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/composer-app/ManagerScreen.jsx", error: String((e && e.message) || e) }); }

// ui_kits/composer-app/PhoneFrame.jsx
try { (() => {
const {
  Signal,
  Battery
...
function PhoneFrame({
  ...
  }, /*#__PURE__*/React.createElement("span", null, "17:58"), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 90,
      height: 24,
      background: 'var(--ink-900)',
  ...
  }, ['Composer', 'Fonts', 'Manager'].map(t => /*#__PURE__*/React.createElement("button", {
    key: t,
    onClick: () => setTab(t),
    style: {
      flex: 1,
      ...
      color: tab === t ? 'var(--white)' : 'var(--ink-500)',
      font: 'var(--text-mono-xs)',
      letterSpacing: 'var(--letter-spacing-mono)'
    }
  }, t.toUpperCase()))));
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/composer-app/PhoneFrame.jsx", error: String((e && e.message) || e) }); }
